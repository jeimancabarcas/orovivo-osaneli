  ...
  template: `
    <section class="py-24 sm:py-32 px-4 sm:px-8 bg-gradient-to-b from-[#111111] to-[#0A1721] relative overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center max-w-3xl mx-auto flex flex-col items-center gap-4 mb-20">
          ...
          <p class="font-sans text-sm sm:text-base text-neutral-400 leading-relaxed max-w-2xl">
            No escatimamos en nada. Desde la selección del hilo hasta la estructura de caída pesada, esta camiseta está concebida como una pieza de colección coleccionable de alta gama.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <!-- Spec 1: Boxy Cut -->
          <div class="p-6 rounded-2xl glass-effect flex flex-col gap-4 hover:border-gold-aged/30 transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div class="mt-20 glass-effect rounded-3xl p-6 sm:p-10 flex flex-col lg:flex-row items-center gap-10">
          <div class="w-full lg:w-1/2 flex flex-col gap-4">
            ...
            <div class="flex flex-wrap gap-4 text-xs font-bold font-sans text-neutral-400">
              <span class="px-3 py-1.5 rounded-lg bg-neutral-900 border border-white/5"><strong class="text-white">Algodón:</strong> 100% Peinado Orgánico</span>
              <span class="px-3 py-1.5 rounded-lg bg-neutral-900 border border-white/5"><strong class="text-white">Hecho En:</strong> Colombia (Herencia y Sello local)</span>
              <span class="px-3 py-1.5 rounded-lg bg-neutral-900 border border-white/5"><strong class="text-white">Cuidado:</strong> Lavar al revés con agua fría</span>
            </div>
          </div>
